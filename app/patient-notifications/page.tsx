...
interface Notification {
  ...
  title: string;
  message: string;
  type: 'appointment_booked' | 'appointment_cancelled' | 'appointment_rescheduled' | 'appointment_reminder' | 'lab_results' | 'prescription_refill' | 'health_tip' | 'system_update';
  read: boolean;
  createdAt: string;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Stay updated with your health</p>
              </div>
            </div>
            {unreadCount > 0 && (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <select
              ...
              className="px-4 py-2 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-300"
            >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-12 shadow-lg border border-white/20 text-center">
              ...
              <p className="text-gray-600">
                {filter === 'unread' ? 'You\'re all caught up!' : 
                 ...
                 'You\'ll get updates about appointments and health alerts here.'}
              </p>
            </div>
          ) : (
